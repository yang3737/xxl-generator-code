...
public class IndexController {
    ...
    public ReturnT<Map<String, String>> codeGenerate(String tableSql) {
        ...
        try {
            ...
            result.put("modelDTO_code", freemarkerTool.processString("xxl-code-generator/modelDTO.ftl", params));

            result.put("repo_code", freemarkerTool.processString("xxl-code-generator/repo.ftl", params));

            result.put("repo_impl_code", freemarkerTool.processString("xxl-code-generator/repo_impl.ftl", params));
